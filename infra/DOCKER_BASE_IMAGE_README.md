...
```
├── Dockerfile.base.prod         # Production базовый образ
├── Dockerfile.base.dev          # Development базовый образ
├── requirements-base-prod.txt   # Production Python зависимости
├── requirements-base-dev.txt    # Development Python зависимости
...
docker build -f infra/Dockerfile.base.prod -t mcp-base:latest . --progress=plain
