...
class TypedGraphMemory:
    ...
    def _prepare_match_expression(self, query: str) -> str:
        ...
        содержащие все значимые слова из запроса.
        """
        # Русские стоп-слова (предлоги, союзы, местоимения)
        stop_words = {
            'о', 'об', 'обо', 'в', 'во', 'к', 'ко', 'с', 'со', 'от', 'ото', 'до', 'по', 'под', 'над',
            'при', 'про', 'для', 'за', 'из', 'изо', 'к', 'ко', 'на', 'над', 'о', 'об', 'обо', 'от',
            'ото', 'перед', 'передо', 'по', 'под', 'подо', 'при', 'про', 'ради', 'с', 'со', 'сквозь',
            'среди', 'у', 'через', 'и', 'а', 'но', 'да', 'или', 'либо', 'то', 'не', 'ни', 'же', 'ли',
            'бы', 'б', 'как', 'что', 'чтобы', 'чтоб', 'когда', 'где', 'куда', 'откуда', 'почему',
            'зачем', 'какой', 'какая', 'какое', 'какие', 'чей', 'чья', 'чьё', 'чьи', 'который',
            'которая', 'которое', 'которые', 'кто', 'что', 'мы', 'вы', 'они', 'он', 'она', 'оно',
            'я', 'ты', 'он', 'она', 'оно', 'мы', 'вы', 'они', 'меня', 'тебя', 'его', 'её', 'нас',
            'вас', 'их', 'мне', 'тебе', 'ему', 'ей', 'нам', 'вам', 'им', 'мной', 'тобой', 'им',
            'ею', 'нами', 'вами', 'ими', 'ми', 'ти', 'хи', 'ми', 'ти', 'хи'
        }
