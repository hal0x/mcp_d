...
from memory_mcp.utils.text.russian_tokenizer import STOP_WORDS, get_tokenizer, get_word_variants
        ...
        *,
        ...
        for idx, row in enumerate(rows):
            ...
            if bm25_range > 0.001:
                ...
                if len(rows) > 1:
                    position_factor = 1.0 - (idx / (len(rows) - 1))
                else:
