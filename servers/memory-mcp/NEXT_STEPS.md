...
### 1. Настроить Qdrant для векторного поиска 🔴 (Критично)
...
### 2. Улучшить гибридный поиск 🟡 (Важно)
...
1. **Сначала:** Настроить Qdrant (критично, дает максимальный эффект)
2. **Затем:** Улучшить гибридный поиск (важно, улучшает качество)
